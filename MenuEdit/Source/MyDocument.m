...
- (IBAction)setOption:(id)sender
{
	...
	[[self getCurrentThemeObject] setObject:[NSNumber numberWithInt:row] forKey:[keyMappings objectAtIndex:[sender tag] - 1]];
	}
	else
	{
...
- (void)openPanelDidEnd:(NSOpenPanel *)sheet returnCode:(int)returnCode contextInfo:(void *)contextInfo
{
	...
	[newImage lockFocus];
	[[[[NSImage alloc] initWithContentsOfFile:[sheet filename]] autorelease] drawInRect:NSMakeRect(0,0,[newImage size].width,[newImage size].height) fromRect:NSZeroRect operation:NSCompositeHighlight fraction:1.0];
